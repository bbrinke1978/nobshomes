      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm">
        ...
        {isAccessDenied && (
          <div className="mb-4 rounded-lg bg-red-50 border border-red-200 px-4 py-3 text-sm text-red-700 text-center">
            Your email is not authorized to access admin.
          </div>
        )}
        ...
        >
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 bg-brand-500 text-white font-semibold px-5 py-3 rounded-xl hover:bg-brand-600 transition-colors shadow-md hover:shadow-lg"
          >
